...
plot(x_1, y_1, 'LineWidth', 1.5, 'color','magenta');
%legend({'Finite Element (Frequency=20Hz)'}, 'FontSize',10, 'TextColor','black')
hold on

plot(x_1, y_2, 'LineWidth', 1.5, 'color','blue');
...
legend({'\rm{$Without\;Trench$}','\rm{$With\;Trench$}'},'FontSize',24, 'FontName','Times New Roman', 'Interpreter','LaTex')
...
xlabel('\rm{Normalized Distance after the Trench}', 'FontSize',20, 'FontName','Times New Roman', 'Interpreter','LaTex')
ylabel('Normalized Soil Particle Velocity', 'FontSize',20, 'FontName','Times New Roman', 'Interpreter','LaTex')
grid on
